        ...
        <div className="mb-14 grid items-end gap-10 lg:mb-20 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          >
            <p className="text-base leading-7 text-neutral-600 sm:text-lg sm:leading-8">
              Explore premium gifts through a clean, immersive and app-inspired
              MacBook shopping experience.
            </p>

            <button
              type="button"
              className="group mt-7 inline-flex items-center gap-3 rounded-full bg-neutral-950 px-6 py-3.5 text-sm font-medium text-white transition hover:bg-neutral-800"
            >
              Explore collection
                  ...
                  <div className="flex items-end justify-between gap-5">
                    <div>
                      ...
                      <p className="mt-1 hidden text-xs text-neutral-500 sm:block">
                        Handpicked gifts for unforgettable moments.
                      </p>
                    </div>
                  ...
                  >
                    {premiumCategories.map((category, index) => (
                      <motion.article
                        ...
                        whileHover={{ y: -6 }}
                        className="group min-w-[145px] overflow-hidden rounded-[18px] border border-white/70 bg-white/80 p-2 shadow-[0_14px_35px_rgba(31,24,18,0.08)] backdrop-blur-xl sm:min-w-[210px] sm:rounded-[24px] sm:p-2.5 lg:min-w-[230px]"
                      >
                        <div className="relative h-[105px] overflow-hidden rounded-[14px] bg-neutral-200 sm:h-[150px] sm:rounded-[19px]">
                          <Image
                            src={category.image}
                            alt={category.title}
                            fill
                          ...
                          {category.badge && (
                            <span className="absolute left-2 top-2 rounded-full bg-black/35 px-2 py-1 text-[7px] uppercase tracking-[0.15em] text-white backdrop-blur-md sm:left-3 sm:top-3 sm:text-[9px]">
                              {category.badge}
                            </span>
                          )}
                        </div>
                        ...
                        <div className="px-1 pb-1 pt-3 sm:px-2 sm:pb-2 sm:pt-4">
                          <h4 className="text-[11px] font-semibold text-neutral-950 sm:text-[15px]">
                            {category.title}
                          </h4>
